Moralis.Cloud.afterSave("ItemListed", async (request) => {
    // Every event gets triggered twice, once it is emitted (not confirmed), and once when it is confirmed
    ...
    if (confirmed) {
        ...
        // Adding a new ActiveItem (a brand new listing or an updated listing)
...
Moralis.Cloud.afterSave("ItemCanceled", async (request) => {
    ...
    if (confirmed) {
        ...
        if (canceledItem) {
            ...
            logger.info(
                `No canceled item found with address: ${request.object.get(
                    "address"
...
Moralis.Cloud.afterSave("ItemBought", async (request) => {
    ...
    if (confirmed) {
        ...
        if (boughtItem) {
            ...
            logger.info(
                `No item bought found with address: ${request.object.get(
                    "address"
                )} and tokenId: ${request.object.get("tokenId")}`
            )
        }
